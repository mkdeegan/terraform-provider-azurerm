...
func TestAccAzureRMLinuxVirtualMachineScaleSet_otherComputerNamePrefix(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMLinuxVirtualMachineScaleSet_otherComputerNamePrefix(ri, location),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMLinuxVirtualMachineScaleSetExists(resourceName),
				),
			},
...
func TestAccAzureRMLinuxVirtualMachineScaleSet_otherPriorityLowDeallocate(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMLinuxVirtualMachineScaleSet_otherPriorityLow(ri, location, "Deallocate"),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMLinuxVirtualMachineScaleSetExists(resourceName),
				),
			},
...
func TestAccAzureRMLinuxVirtualMachineScaleSet_otherPriorityRegular(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMLinuxVirtualMachineScaleSet_otherPriorityRegular(ri, location),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMLinuxVirtualMachineScaleSetExists(resourceName),
				),
			},
...
func TestAccAzureRMLinuxVirtualMachineScaleSet_otherTags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMLinuxVirtualMachineScaleSet_otherTags(ri, location),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMLinuxVirtualMachineScaleSetExists(resourceName),
				),
			},
			...
			{
				// add one
				Config: testAccAzureRMLinuxVirtualMachineScaleSet_otherTagsUpdated(ri, location),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMLinuxVirtualMachineScaleSetExists(resourceName),
				),
			},
...
func TestAccAzureRMLinuxVirtualMachineScaleSet_otherTerminationProfile(t *testing.T) {
	resourceName := "azurerm_linux_virtual_machine_scale_set.test"
	ri := tf.AccRandTimeInt()
	location := testLocation()
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMLinuxVirtualMachineScaleSet_otherTerminationProfile(ri, location, true, "PT5M"),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMLinuxVirtualMachineScaleSetExists(resourceName),
				),
			},
			...
			{
				Config: testAccAzureRMLinuxVirtualMachineScaleSet_otherTerminationProfile(ri, location, false, "PT10M"),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMLinuxVirtualMachineScaleSetExists(resourceName),
				),
			},
...
func testAccAzureRMLinuxVirtualMachineScaleSet_otherSecret(rInt int, location string, rString string) string {
	template := testAccAzureRMLinuxVirtualMachineScaleSet_otherSecretTemplate(rInt, location, rString)
	return fmt.Sprintf(`
%s
...
func testAccAzureRMLinuxVirtualMachineScaleSet_otherSecretRemoved(rInt int, location string, rString string) string {
	template := testAccAzureRMLinuxVirtualMachineScaleSet_otherSecretTemplate(rInt, location, rString)
	return fmt.Sprintf(`
%s
...
func testAccAzureRMLinuxVirtualMachineScaleSet_otherSecretUpdated(rInt int, location string, rString string) string {
	template := testAccAzureRMLinuxVirtualMachineScaleSet_otherSecretTemplate(rInt, location, rString)
	return fmt.Sprintf(`
%s
...
func testAccAzureRMLinuxVirtualMachineScaleSet_otherSecretTemplate(rInt int, location string, rString string) string {
	template := testAccAzureRMLinuxVirtualMachineScaleSet_template(rInt, location)
	return fmt.Sprintf(`
%s
...
func testAccAzureRMLinuxVirtualMachineScaleSet_otherTagsUpdated(rInt int, location string) string {
	template := testAccAzureRMLinuxVirtualMachineScaleSet_template(rInt, location)
	return fmt.Sprintf(`
%s
...
func testAccAzureRMLinuxVirtualMachineScaleSet_otherTerminationProfile(rInt int, location string, enabled bool, notBeforeTimeout string) string {
	template := testAccAzureRMLinuxVirtualMachineScaleSet_template(rInt, location)
	return fmt.Sprintf(`
%s
...
resource "azurerm_linux_virtual_machine_scale_set" "test" {
  ...
  scheduled_event {
    termination_profile {
      enabled            = %t
      not_before_timeout = %q
    }
  }
}
`, template, rInt, enabled, notBeforeTimeout)
}

func testAccAzureRMLinuxVirtualMachineScaleSet_otherVMAgent(rInt int, location string, enabled bool) string {
	template := testAccAzureRMLinuxVirtualMachineScaleSet_template(rInt, location)
	return fmt.Sprintf(`
%s
